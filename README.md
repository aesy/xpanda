...
[`envsubst`](https://www.gnu.org/software/gettext/manual/html_node/envsubst-Invocation.html) but don't want to resort to
using Bash's [`eval`](https://www.gnu.org/software/bash/manual/html_node/Bourne-Shell-Builtins.html), while also not
...
* [Rust Stable 1.96.0+](https://www.rust-lang.org/tools/install)
...
And fuzz testing, located in the `xpanda-fuzz` directory, can be run using the
...
It must then be run using the [nightly channel](https://rust-lang.github.io/rustup/concepts/channels.html):
